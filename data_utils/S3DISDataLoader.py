...
class S3DISDataset(Dataset):
    def __init__(self, split='train', data_root='trainval_fullarea', num_point=4096, test_area=5, block_size=1.0, sample_rate=1.0, transform=None):
        ...
        folders = glob.glob('/content/gdrive/My Drive/AI/Swiss/sampling/*')
        ALL_FILES = []
       ...
       # else:
        ...
        for room_name in ALL_FILES:
            ...
            room_data = np.load(room_name)  # xyzrgbl, N*7
...
class ScannetDatasetWholeScene():
    ...
    def __getitem__(self, index):
        ...
        print(data_room.shape,label_room.shape,sample_weight.shape,index_room.shape )
...
if __name__ == '__main__':
    data_root = '/content/gdrive/My Drive/AI/pointnet/vkitti3D-dataset/vkitti3d_dataset_v1.0/*'
