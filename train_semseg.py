...
writer_1 = SummaryWriter(log_dir='./log/train')
writer_2 = SummaryWriter(log_dir='./log/test')
...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default='semseg', help='Log path [default: None]')
...
def main(args):
    ...
    for epoch in range(start_epoch,args.epoch):
        ...
        writer_1.add_scalar('Loss/train', (loss_sum / num_batches), epoch)
        writer_1.add_scalar('Accuracy/train', total_correct / float(total_seen), epoch)

        if epoch % 5 == 0:
            logger.info('Save model...')
            savepath = str(experiment_dir) + '/model.pth'
        ...
        with torch.no_grad():
            ...
            writer_2.add_scalar('Loss/validation', (loss_sum / num_batches), epoch)
            writer_2.add_scalar('Accuracy/validation', total_correct / float(total_seen), epoch)
